...
public final class GestionUsuarios {
    ...
    public Usuario crearUsuario() {
        ...
        //Crea el objeto usuario cargado de información para el registro
        Usuario usuario = new Usuario();

        System.out.println("Vamos a registrarte en nuestro gestor de balneario.");
        usuario.setActivo(true);
        usuario.setTipoUsuario(TipoUsuario.BASICO);
    ...
    public static JSONObject pasarUsuarioAObject(Usuario usuario) {
        ...
        try {
            ...
            JsonObj.put("tipoUsuario", usuario.getTipoUsuario().toString());
    ...
    public Usuario pasarJSONObjectAUsuario(JSONTokener tokener) {
        ...
        usuario.setTipoUsuario(TipoUsuario.valueOf(JSONObj.getString("tipoUsuario")));
    ...
    public static Usuario bajaPasivaUsuario() {
        ...
        for (int i = 0; i < arrTemp.length(); i++) {//Recorro el JsonArray objeto por objeto
            ...
            JSONObj = arrTemp.getJSONObject(i); //Voy guardando cada usuario  en un JsonObject

            if (JSONObj.getBoolean("estado")) {   //Imprimo solo los Activos

                System.out.println("Nombre : " + JSONObj.getString("nombre") + " - Apellido : " + JSONObj.getString("apellido") + " - DNI: " + JSONObj.getString("DNI"));
...
do {
    System.out.println("Ingresa el DNI del usuario que deseas eliminar");
    String dniABorrar = scan.nextLine();
    ...
    for (int i = 0; i < arrTemp.length(); i++) {
        ...
        if (JSONObj.getString("DNI").equals(dniABorrar)) {
    ...
    System.err.println("El DNI ingresado no pertenece a un usuario.");
} while (true);
